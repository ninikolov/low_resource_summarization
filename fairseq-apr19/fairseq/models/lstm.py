...
@register_model_architecture('lstm', 'lstm_tiny')
def base_architecture(args):
    args.dropout = getattr(args, 'dropout', 0.1)
...
@register_model_architecture('lstm', 'lstm_1000')
def base_architecture(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    ...
    args.decoder_freeze_embed = getattr(args, 'decoder_freeze_embed', False)
    # args.decoder_hidden_size = getattr(args, 'decoder_hidden_size', args.decoder_embed_dim)
    args.decoder_hidden_size = getattr(args, 'decoder_hidden_size', 1000)
    args.decoder_layers = getattr(args, 'decoder_layers', 1)
...
@register_model_architecture('lstm', 'lstm_1000_2layer')
def base_architecture(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 500)
    args.encoder_embed_path = getattr(args, 'encoder_embed_path', None)
